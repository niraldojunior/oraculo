          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            ...
            <div>
              <h2 style={{ fontSize: '1.5rem', fontWeight: 800, margin: 0, letterSpacing: '-0.02em' }}>
                {isEditing ? 'Gerenciar Organiza��o' : 'Dados da Organiza��o'}
              </h2>
              <p style={{ fontSize: '0.85rem', color: 'var(--text-tertiary)', margin: 0 }}>
                {isEditing ? 'Atualize as informa��es corporativas e identidade visual' : 'Visualiza��o das informa��es corporativas cadastradas'}
              </p>
            </div>
          </div>
          ...
          {isEditing ? (
            <form onSubmit={handleSave} style={{ display: 'grid', gridTemplateColumns: '1fr 340px', gap: '3rem' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1rem', padding: '1.5rem', background: '#F8FAFC', borderRadius: '24px', border: '1px solid var(--glass-border)' }}>
                  ...
                  <p style={{ fontSize: '0.8rem', color: 'var(--text-secondary)', textAlign: 'center' }}>Visualize como seu logotipo ser� exibido nos pain�is.</p>
                </div>

                <div className="form-group">
                  <label style={{ fontSize: '0.75rem', fontWeight: 800, color: 'var(--text-tertiary)', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '0.5rem', display: 'block' }}>
                    Descri��o do Prop�sito
                  </label>
                  <textarea 
                    style={{ 
                    ...
                    placeholder="Descreva o prop�sito e vis�o da organiza��o..."
                  />
                </div>
              </div>
            </form>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 340px', gap: '3rem' }}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                ...
                <div>
                  <p style={{ fontSize: '0.7rem', fontWeight: 800, color: 'var(--text-tertiary)', textTransform: 'uppercase', marginBottom: '0.75rem', letterSpacing: '0.05em' }}>Descri��o</p>
                  <p style={{ fontSize: '1.05rem', lineHeight: 1.7, color: 'var(--text-secondary)', margin: 0 }}>
                    {currentCompany.description || 'Nenhuma descri��o dispon�vel.'}
                  </p>
                </div>
              </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                <div style={{ 
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
                    <Building size={18} color="var(--text-tertiary)" />
                    <span style={{ fontWeight: 700, fontSize: '0.9rem' }}>Segmenta��o</span>
                  </div>

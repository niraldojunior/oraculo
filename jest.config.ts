...
const config: Config = {
  ...
  collectCoverageFrom: [
    ...
    'src/infrastructure/persistence/oracle/OracleBusinessUnitRepository.ts',
    'src/infrastructure/persistence/oracle/OracleClientTeamRepository.ts',
    ...
    'src/infrastructure/persistence/prisma/PrismaBusinessUnitRepository.ts',
    'src/infrastructure/persistence/prisma/PrismaClientTeamRepository.ts',

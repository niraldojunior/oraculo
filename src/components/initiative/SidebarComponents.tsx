...
export const renderAvatar = (collaboratorId: string | null | undefined, allCollaborators: Collaborator[], size: number = 20) => {
  ...
  if (collaborator.photoUrl) {
    return <img loading="lazy" src={collaborator.photoUrl} alt={collaborator.name} title={collaborator.name} style={{ width: size, height: size, borderRadius: '50%', objectFit: 'cover' }} />;
  }
